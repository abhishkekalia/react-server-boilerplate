              ...
              {this.state.userdata.map((dynamicData, Key) => {
                return (
                  <tr key={dynamicData._id} style={{borderBottom: '1px solid red' }} className="animated fadeIn">
                    ...
                    <td>{dynamicData.pageId} </td>
                    <td>{dynamicData.updatedAt} </td>
                    <td>{dynamicData.createdAt} </td>
                    <td>
                      <button onClick={() => this.props.deleteCms(dynamicData._id)}><i className="fa fa-trash" aria-hidden="true"></i></button>
                      <button onClick={this.editCmslist.bind(this, dynamicData)}><i className="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                    </td>
                  </tr>
...
export default withRouter(connect(mapStateToProps, actions)(UserTable));
