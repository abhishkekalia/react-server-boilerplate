...
import BlogTable from '../BlogManagement/BlogTable';
import BlogFilter from '../BlogManagement/BlogFilter';
...
class BlogManagement extends Component {
  ...
  getallblog() {
    ...
    try {
      ...
      console.log(body);
      this.props.bloglist(body, access_token, (response) => {
        let { data } = response;
        if (data.status == 1) {
      ...
      <Home>
        <div>
          <div className="row">
            ...
            <div className="col-md-8">
              <div className="button-continer text-right">
                <button type="button" className="btn btn-primary" onClick={() => this.props.history.push('/newblog')}><i className="mdi mdi-plus" /> Add User</button>
              </div>
            </div>
          </div>
          <hr />
          ...
          <div className="animated fadeInUp">
            ...
            <div>
              <BlogFilter show={this.state.show} dataTofilter={this.state.userdata} access_token={this.props.token} applyFilter={this.applyFilter.bind(this)}  cancelFilter={this.cancelFilter.bind(this)}/>
            </div>
            <div>
              <BlogTable columnElement={["blogContent","blogTitle","metaTitle","metaKeyword"]} sortChange={this.sortChange.bind(this)} userdata={this.state.alldata} Deleteselectedbox={this.Deleteselectedbox.bind(this)} userstatusChange={this.userstatusChange.bind(this)} deleteCms={this.deleteCms.bind(this)} />
...
export default withRouter(connect(mapStateToProps, actions)(BlogManagement));
